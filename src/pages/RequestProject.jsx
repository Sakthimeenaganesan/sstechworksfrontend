...
<div className="mt-10 space-y-6">
  ...
  <p className="text-lg text-gray-600 leading-relaxed">
    Every successful project starts with clarity. We take time to understand
    your requirements, suggest the right technology stack and structure
    the solution professionally from the foundation.
  </p>

  <p className="text-lg text-gray-600 leading-relaxed">
    Whether it's a mini project, final year submission or a scalable
    web/mobile application, we ensure your project is technically strong,
    well-documented and presentation-ready.
  </p>

  <p className="text-lg font-semibold text-gray-800 leading-relaxed">
    From planning to deployment, we stay connected with you at every step —
    ensuring confidence, quality and timely delivery.
  </p>
  ...
  <p className="text-red-500 text-sm mt-1">
    {errors.email}
            ...
            <Input
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="scoobydoo@example.com"
            />
