...
export default function AdminLogin() {
  ...
  const getUserData = () => {
    ...
    if (cleanEmail === "msathiyapriya1305@gmail.com")
      return { name: "Sathiyapriya", avatar: sathiyaImg };

    if (cleanEmail === "sstechworks26@gmail.com")
      return { name: "SSTechWorks", avatar: companyImg };
      ...
      >
        ...
        <div className="flex justify-center pt-8">
          {avatar ? (
            ...
            <div className="w-20 h-20 rounded-full bg-indigo-100 flex items-center justify-center text-2xl">
              👤
            </div>
          )}
        </div>
